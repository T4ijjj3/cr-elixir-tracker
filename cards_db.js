...
const META_DECKS = [
    ...
    { name: 'Sparky GG Mini PEKKA', weight: 10, cards: ['Goblin Gigante', 'Sparky', 'Mini PEKKA', 'Fênix', 'Mago Elétrico', 'Fúria', 'Choque (Zap)', 'Eletrocutadores'] },
...
const ALL_CARDS = [
    ...
    { name: 'Vinhas', cost: 2, type: 'S', image: 'images/Vinhas.png' },
    ...
    { name: 'Dragões Esqueleto', cost: 3, type: 'T', image: 'images/Dragões Esqueleto.png' },
    ...
    { name: 'Vácuo', cost: 3, type: 'S', image: 'images/Veneno.png' }, // Placeholder image until dedicated asset is added
    ...
    // 7 de Elixir
    { name: 'Cabana de Bárbaros', cost: 7, type: 'B', image: 'images/Bárbaros.png' }, // No specific image for hut usually in simple packs
